...
# --- 하단 푸터 (유저정보 및 Logout 통합형) ---
st.divider()

# 레이아웃 비율 조정 (연락처/링크들 : 유저정보 및 로그아웃)
# 6.5(기존 푸터 내용) : 3.5(유저 정보 및 버튼)
        ...
        with u_col1:
            ...
            st.markdown(f"""
                <div style='text-align: right; padding-top: 5px;'>
                    <span style='font-size: 13px; color: #1E3A8A; font-weight: 700; 
                    background-color: #f8f9fa; padding: 4px 10px; border-radius: 10px; border: 1px solid #e2e8f0;'>
