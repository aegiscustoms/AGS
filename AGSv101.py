...
if not st.session_state.logged_in:
    with login_screen.container():
        st.markdown(f"""
            <div style='text-align: center; padding-top: 100px; margin-bottom: 30px; 
                        display: flex; flex-direction: column; align-items: center; justify-content: center; width: 100%;'>
                <h1 style='color: #1E3A8A; font-size: 48px; font-weight: 800; 
                            margin: 0; padding: 0; line-height: 1.0; letter-spacing: -1.5px;
                            display: block; width: 100%;'>A.G.S</h1>
                
                <p style='color: #595959; font-size: 14px; font-weight: 500; 
                            margin: 0; padding: 0; margin-top: -2px; letter-spacing: -0.5px;
                            display: block; width: 100%;'>[Aegis Guide Station]</p>
            </div>
        """, unsafe_allow_html=True)
