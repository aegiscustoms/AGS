...
if not st.session_state.logged_in:
    with login_screen.container():
        st.markdown(f"""
            <div style='text-align:center; padding-top:100px; margin-bottom: 20px;'>
                <h1 style='color:#1E3A8A; font-size:48px; font-weight:800; margin-bottom: 5px; letter-spacing: -1px;'>
                    A.G.S
                </h1>
                <p style='color:#595959; font-size:12px; font-weight:500; margin-top: 0px;'>
                    [Aegis Guide Station]
                </p>
            </div>
        """, unsafe_allow_html=True)
