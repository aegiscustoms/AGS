        ...
        if not uploaded_file and not input_summary:
            ...
            with st.spinner("🔍 AI 전문 관세사가 물품정보를 분석 중입니다..."):
                try:
                    ...
                    6. (세번 확정) 정확히 동일한 품명의 4단위 호가 있는 경우 하위 6단위를 찾아 확정하며, 특계된 호가 없다면 제일 하위에 '기타' 호로 분류할 것.
                    ...
                    **2. 추천 HS Code (10자리)**: <span style='font-size:20px; font-weight:bold;'>XXXX.XX</span> (예상 확률 %) 
