...
if st.session_state.get('logged_in', False):
    st.markdown(f"""
        ...
        <div class="top-info-container">
            <div class="user-tag-final">{st.session_state.user_name}님</div>
            <div style="width: 75px; height: 28px;"></div> </div>
    """, unsafe_allow_html=True)

    # 실제 로그아웃 버튼 (확보된 자리 위로 절대 위치 고정)
...
st.markdown("<div style='margin-top: -15px; border-bottom: 1px solid #E2E8F0; margin-bottom: 20px;'></div>", unsafe_allow_html=True)
