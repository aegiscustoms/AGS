...
# --- [Tab 2] HS정보 (좌우 레이아웃 및 80px 열 너비 반영) --- #변경내역★★
with tabs[1]:
            ...
            try:
                ...
                if not m.empty or not std.empty:
                    ...
                    if not r_all.empty:
                        ...
                        # [보정] 세율 테이블 스타일: 열 너비 80px 및 자동 줄바꿈 적용 #변경내역★★
                        def styled_rate_table(df, is_scroll=False):
                            ...
                            # [보정] 코드와 세율 열을 80px로 고정 #변경내역★★
                            html += '<colgroup><col style="width:100px;"><col style="width:auto;"><col style="width:100px;"></colgroup>'
