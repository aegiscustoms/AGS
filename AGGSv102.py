...
def load_aggs_master_data():
    ...
    # 1. Master Data (HS코드, 품명 등)
    df_master = conn.read(spreadsheet="https://docs.google.com/spreadsheets/d/1FuqaAf2qr6wg76xF4ieWbDy4_ot5C2ClubYq33aMxGo/edit?usp=sharing")
    # 2. Tariff Data (세율)
    df_tariff = conn.read(spreadsheet="https://docs.google.com/spreadsheets/d/1kw9WMhHOkjE-GIqkuC97QQDB9GCQZdHwloPAOx_d_3E/edit?usp=sharing")
    # 3. Req Data (세관장/통합공고 요건)
    # AGGS_Req 시트는 탭이 여러개이므로 각각 읽어옵니다.
    df_req_im = conn.read(spreadsheet="https://docs.google.com/spreadsheets/d/1kEMJujmsUVemtfO2oh1DoO9L_aGZMygtbVPrafiEPxQ/edit?usp=sharing", worksheet="Req_IM")
    df_req_ex = conn.read(spreadsheet="https://docs.google.com/spreadsheets/d/1kEMJujmsUVemtfO2oh1DoO9L_aGZMygtbVPrafiEPxQ/edit?usp=sharing", worksheet="Req_EX")
    df_cpan_im = conn.read(spreadsheet="https://docs.google.com/spreadsheets/d/1kEMJujmsUVemtfO2oh1DoO9L_aGZMygtbVPrafiEPxQ/edit?usp=sharing", worksheet="CPAN_IM")
    df_cpan_ex = conn.read(spreadsheet="https://docs.google.com/spreadsheets/d/1kEMJujmsUVemtfO2oh1DoO9L_aGZMygtbVPrafiEPxQ/edit?usp=sharing", worksheet="CPAN_EX")
