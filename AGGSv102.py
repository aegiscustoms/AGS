...
with tabs[1]:
    ...
    if target_hs != "0000000000":
        ...
        with col_m1:
            ...
            st.markdown(f"<div style='background-color: #F0FDF4; padding: 15px; border-radius: 10px; border-left: 5px solid #22C55E; color: #166534; font-size: 13px;'>{sn_val}</div>", unsafe_allow_html=True)
        with col_m2:
            st.write("📂 **기본품명**")
