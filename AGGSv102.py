    ...
    if target_hs_raw != "0000000000":
        ...
        st.markdown(f"""
            <style>
                ...
                /* 표준품명/기본품명 컨테이너 */
                .box-base { padding: 15px; border-radius: 8px; border-left: 6px solid; min-height: 110px; line-height: 1.6; margin-bottom: 10px; }
                ...
                /* 통합공고 요령 폰트 10px 및 좌측 정렬 */
                .small-font-table div[data-testid="stDataFrame"] td {
