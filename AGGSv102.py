...
# --- [Tab 3] 통계부호 통합 조회 서비스 (기존 코드를 이 내용으로 교체하세요) --- 
with tabs[2]:
    st.markdown("<div class='custom-header'>📊 통계부호 조회 </div>", unsafe_allow_html=True)
    ...
    MAP_FIX = {
        "BL구분코드": "BL_TPCD", "BL분할사유코드": "BL_DVDE_RCD", "BL유형코드": "BL_PCD", "CIQ수속장소구분코드": "CIQ_PRCD_PLC_TPCD", 
        "COB화물검사결과코드": "COB_CARG_INSC_RSCD", "COB화물변경사유코드": "COB_CARG_CHNG_RCD", "CY_CFS구분코드": "CY_CFS_TPCD", 
        "FTA원산지결정기준코드": "FTA_ORCY_DTRM_BASE_CD", "IMDG위험물구분코드": "IMDG_DNAR_TPCD", "가격신고항목코드": "PRC_DCLR_ITEM_CD", 
        "가격조건코드": "PRC_COND_CD", "가산세면제사유코드": "ADTX_EXMP_RCD", "가족관계코드": "FMLY_RLCD", "간이수출검사결과코드": "SIML_EXP_INSC_RSCD", 
        "감시분석대상구분코드": "SRVL_ANAY_TRGT_TPCD", "개장검사내역처리상태코드": "OPBG_INSC_BRKD_PRCS_STCD", "개장검사물품확인결과코드": "OPBG_INSC_CMDT_CFRM_RSCD", 
        "거래근거문서구분코드": "DLNG_BSS_DOC_TPCD", "거주상태코드": "RSDN_STCD", "건설기계업무코드": "CNSC_MCHN_BSOP_CD", "건설기계차종코드": "CNSC_MCHN_KCAR_CD", 
        "검사검역지정유형코드": "INSC_QUAN_APNT_PCD", "검사대상비지정사유코드": "INSC_TRGT_NNAPNT_RCD", "검사대상해제사유코드": "INSC_TRGT_RELE_RCD", 
        "검사방법코드": "INSC_MCD", "검색기검사처리상태코드": "DTCT_INSC_PRCS_STCD", "결손처분사유코드": "DFCT_DSPS_RCD", "결제구분코드": "STLM_TPCD", 
        "결제방법코드": "STLM_MCD", "경제권종류코드": "EBK_KCD", "계코드": "DPRT_CD", "고발사유코드": "CHRG_RCD", "고발의견코드": "CHRG_OPIN_CD", 
        "고발처분코드": "CHRG_DSPS_CD", "고지유형코드": "NFCPN_PCD", "과다환급추징유형코드": "EXCS_DRWB_ADCH_PCD", "과징금코드": "FNDF_CD", 
        "관내입항지구분코드": "WTJR_ENTP_TPCD", "관리대상화물검사결과코드": "MT_TRGT_CARG_INSC_RSCD", "관리대상화물검사구분코드": "MT_TRGT_CARG_INSC_TPCD", 
        "관리대상화물수작업선별사유코드": "MT_TRGT_CARG_HNWR_SELC_RCD", "관리대상화물조치결과코드": "MT_TRGT_CARG_TKAC_RSCD", 
        "관리대상화물중량초과구분코드": "MT_TRGT_CARG_WGHT_OVER_TPCD", "관리대상화물해제사유코드": "MT_TRGT_CARG_RELE_RCD", "관세감면분납코드": "TRIF_RDEX_INPY_CD", 
        "관세사거래관계기재구분코드": "LCA_DLNG_REL_STTM_TPCD", "관세사검사의견기재구분코드": "LCA_INSC_OPIN_STTM_TPCD", "관세사별제재사유코드": "LCA_PR_RSTN_RCD", 
        "관세사표창구분코드": "LCA_CMNN_TPCD", "관세사품명규격기재구분코드": "LCA_PRNM_STSZ_STTM_TPCD", "관세율구분코드": "TRRT_TPCD", 
        "관세청업종코드": "KCS_INTP_CD", "교육세과세구분코드": "EDTX_TX_TPCD", "국세청법인구분코드": "NTS_JRPN_TPCD", "국세청법인성격코드": "NTS_JRPN_CHACR_CD", 
        "국세청업종코드": "NTS_INTP_CD", "귀책사유코드": "IMPT_RCD", "근무반구분코드": "BWRK_CLSS_TPCD", "까르네물품용도코드": "CARN_CMDT_USG_CD", 
        "남북교역구분코드": "NSKOR_TRDE_TPCD", "남북통행정정항목코드": "NSKOR_PASG_MDFY_ITEM_CD", "납기연장사유코드": "TPAY_XTNS_RCD", 
        "내국물품반출입정정항목코드": "DMSC_CMDT_RLBR_MDFY_ITEM_CD", "내국세구분코드": "ITX_TPCD", "내국세세종코드": "ITX_TXTP_CD", 
        "농특세과세구분코드": "RDTX_TX_TPCD", "담당자변경사유코드": "CHPN_CHNG_RCD", "담보업체변경사유코드": "MG_ENTS_CHNG_RCD", 
        "담보업체취소사유코드": "MG_ENTS_CNCL_RCD", "담보제공사유코드": "MG_OFR_RCD", "담보종류코드": "MG_KCD", "대륙종류코드": "CNTN_KCD", 
        "대상업체구분코드": "TRGT_ENTS_TPCD", "동향구분코드": "TRND_TPCD", "동향유형코드": "TRND_PCD", "마약물품종류코드": "NRCT_CMDT_KCD", 
        "마약약리작용구분코드": "NRCT_MDAC_ACTI_TPCD", "마약은닉장소코드": "NRCT_CNCM_PLC_CD", "마약의약용도구분코드": "NRCT_DRG_USG_TPCD", 
        "마약적발경위구분코드": "NRCT_DSCL_CRCM_TPCD", "마약적발관련자처리상태코드": "NRCT_DSCL_RELAPN_PRCS_STCD", "마약조직원역할코드": "NRCT_ORGM_ROLE_CD", 
        "마약종류코드": "NRCT_KCD", "마약코드": "NRCT_CD", "마약투여방법코드": "NRCT_INJC_MCD", "마약형태코드": "NRCT_FORM_CD", "말소구분코드": "ERSR_TPCD", 
        "물품반입구분코드": "CMDT_BRNG_TPCD", "물품용도코드": "CMDT_USG_CD", "물품용역업체항공영업종류코드": "CMDT_SBCN_ENTS_FLGH_BUSN_KCD", 
        "물품용역업체해상영업종류코드": "CMDT_SBCN_ENTS_SEA_BUSN_KCD", "물품폐기사유코드": "CMDT_DSCD_RCD", "미가산사유코드": "NADTN_RCD", 
        "밀수근원코드": "SMGL_SRC_CD", "밀수신고접수방법코드": "SMGL_DCLR_ACAP_MCD", "반입경로코드": "BRNG_PATH_CD", "반입유형코드": "BRNG_PCD", 
        "반출기간연장구분코드": "RLSE_PRID_XTNS_TPCD", "반출사유코드": "RLSE_RCD", "반출유형코드": "RLSE_PCD", "반출입외화용도구분코드": "RLBR_FRCR_USG_TPCD", 
        "발각원인코드": "DSLS_CSE_CD", "범칙물품상표코드": "INRG_CMDT_BRND_CD", "범칙물품유형코드": "INRG_CMDT_PCD", "범칙상세경로코드": "INRG_DTL_PATH_CD", 
        "범칙수단코드": "INRG_METH_CD", "범행동기코드": "CRIM_MTV_CD", "법령종류코드": "LWOR_KCD", "법령코드": "LWOR_CD", "법무부출입국도시코드": "MOJ_EDCY_CITY_CD", 
        "법조문구분코드": "LW_CDLN_TPCD", "병역구분코드": "MISR_TPCD", "보세구역구분코드": "SNAR_TPCD", "보세구역반출입정정항목코드": "SNAR_RLBR_MDFY_ITEM_CD", 
        "보세구역반출입화물종류코드": "SNAR_RLBR_CARG_KCD", "보세운송검사구분코드": "BNBN_TRNP_INSC_TPCD", "보세운송검사대상구분코드": "BNBN_TRNP_INSC_TRGT_TPCD", 
        "보세운송검사지정상태코드": "BNBN_TRNP_INSC_APNT_STCD", "보세운송검사처리상태코드": "BNBN_TRNP_INSC_PRCS_STCD", 
        "보세운송승인신청담보구분코드": "BNBN_TRNP_APRE_RQST_MG_TPCD", "보세운송승인신청사유코드": "BNBN_TRNP_APRE_RQST_RCD", "보수작업형태코드": "RPR_WKNG_FORM_CD", 
        "보정심사생략구분코드": "RVSN_AUDT_OMIT_TPCD", "보정심사수작업선별사유코드": "RVSN_AUDT_HNWR_SELC_RCD", "보정심사처리상태코드": "RVSN_AUDT_PRCS_STCD", 
        "봉인내역코드": "SELG_BRKD_CD", "봉인지정내역처리상태코드": "SELG_APNT_BRKD_PRCS_STCD", "부가세과세구분코드": "VAT_TX_TPCD", 
        "분할반출입구분코드": "DVDE_RLBR_TPCD", "분할통합사유코드": "DVDE_UNFC_RCD", "비위유형코드": "AGTL_PCD", "사건근거구분코드": "INCD_BSS_TPCD", 
        "사업자구분코드": "BSNS_TPCD", "사업종류코드": "BUSI_KCD", "사이트유형코드": "SITE_PCD", "사전세액심사선별기준코드": "BTAA_SELC_BASE_CD", 
        "사후관리방법코드": "AFFC_MT_MCD", "사후관리비대상사유코드": "AFFC_MT_NNOB_RCD", "사후관리조치결과코드": "AFFC_MT_TKAC_RSCD", 
        "사후관리조치상태코드": "AFFC_MT_TKAC_STCD", "사후관리종결일자구분코드": "AFFC_MT_CONC_DT_TPCD", "사후관리확인결과코드": "AFFC_MT_CFRM_RSCD", 
        "사후관리확인방법코드": "AFFC_MT_CFRM_MCD", "상이내역코드": "DFRN_BRKD_CD", "상표코드": "BRND_CD", "서류제출변경사유코드": "ISTM_SBMT_CHNG_RCD", 
        "선기용품적재물품구분코드": "SHAR_SUPL_LOAD_CMDT_TPCD", "선박일제점검결과코드": "SHIP_ALTG_CHK_RSCD", "선박종류코드": "SHIP_KCD", 
        "선별검사종류코드": "SELC_INSC_KCD", "선별사유코드": "SELC_RCD", "선별종류코드": "SELC_KCD", "선원구분코드": "CREW_TPCD", "성별코드": "GNDR_CD", 
        "세관장확인대상법령코드": "CSOR_CFRM_TRGT_LWOR_CD", "세관처분유형코드": "CSTM_DSPS_PCD", "세외수입위반유형코드": "NTRV_VLTN_PCD", 
        "소요량산정방법코드": "RQTY_CLCU_MCD", "수리전반출승인사유코드": "BFAC_RLSE_APRE_RCD", "수리전반출취소사유코드": "BFAC_RLSE_CNCL_RCD", 
        "수사지휘구분코드": "INVS_CMND_TPCD", "수입각하사유코드": "IMP_RJCT_RCD", "수입거래구분코드": "IMP_DLNG_TPCD", "수입검사결과코드": "IMP_INSC_RSCD", 
        "수입검사구분코드": "IMP_INSC_TPCD", "수입검사변경사유코드": "IMP_INSC_CHNG_RCD", "수입검사변경코드": "IMP_INSC_CHNG_CD", 
        "수입검사생략사유코드": "IMP_INSC_OMIT_RCD", "수입귀책사유코드": "IMP_IMPT_RCD", "수입보완요구사유코드": "IMP_SPLM_REQS_RCD", 
        "수입성질코드": "IMP_TMPR_CD", "수입신고구분코드": "IMP_DCLR_TPCD", "수입신고정정사유코드": "IMP_DCLR_MDFY_RCD", "수입자구분코드": "IMPPN_TPCD", 
        "수입전산선별사유코드": "IMP_INTC_SELC_RCD", "수입정정항목코드": "IMP_MDFY_ITEM_CD", "수입조건변경구분코드": "IMP_COND_CHNG_TPCD", 
        "수입조치사항코드": "IMP_TKAC_MATR_CD", "수입종류코드": "IMP_KCD", "수입취하사유코드": "IMP_WTHD_RCD", "수입통관계획코드": "IMP_CSCL_PLAN_CD", 
        "수입통관미결사유코드": "IMP_CSCL_UNDC_RCD", "수입통관처리상태코드": "IMP_CSCL_PRCS_STCD", "수작업선별사유코드": "HNWR_SELC_RCD", 
        "수작업수납등록사유코드": "HNWR_RCVE_RGSR_RCD", "수출거래구분코드": "EXP_DLNG_TPCD", "수출검사결과조치코드": "EXP_INSC_RSLT_TKAC_CD", 
        "수출검사결과코드": "EXP_INSC_RSCD", "수출검사구분코드": "EXP_INSC_TPCD", "수출검사변경사유코드": "EXP_INSC_CHNG_RCD", "수출귀책사유코드": "EXP_IMPT_RCD", 
        "수출반송사유코드": "EXP_RETU_RCD", "수출보완요구사유코드": "EXP_SPLM_REQS_RCD", "수출성질코드": "EXP_TMPR_CD", "수출신고각하사유코드": "EXP_DCLR_RJCT_RCD", 
        "수출신고구분코드": "EXP_DCLR_TPCD", "수출신고정정사유코드": "EXP_DCLR_MDFY_RCD", "수출신고제출서류구분코드": "EXP_DCLR_SBMT_ISTM_TPCD", 
        "수출신고처리상태코드": "EXP_DCLR_PRCS_STCD", "수출신고취하사유코드": "EXP_DCLR_WTHD_RCD", "수출신고항목코드": "EXP_DCLR_ITEM_CD", 
        "수출입신고각하사유코드": "IMEX_DCLR_RJCT_RCD", "수출자구분코드": "EXPPN_TPCD", "수출접수결과구분코드": "EXP_ACAP_RSLT_TPCD", "수출종류코드": "EXP_KCD", 
        "수출형태구분코드": "EXP_FORM_TPCD", "수출형태코드": "EXP_FORM_CD", "신고구분코드": "DCLR_TPCD", "신고업체페이퍼리스제재사유코드": "DCLR_ENTS_PLS_RSTN_RCD", 
        "신병조치결과코드": "RKE_TKAC_RSCD", "신청방법코드": "RQST_MCD", "신청서처리상태코드": "APFM_PRCS_STCD", "신청인구분코드": "APLC_TPCD", 
        "심사근거번호구분코드": "AUDT_BSS_NO_TPCD", "심사의견구분코드": "AUDT_OPIN_TPCD", "압수물품처분유형코드": "CFSC_CMDT_DSPS_PCD", 
        "업무영역코드": "BSOP_TRTR_CD", "업체평가등급코드": "ENTS_EV_GD_CD", "여권발급지역코드": "PSPR_ISS_REGN_CD", "여행목적코드": "TRVL_PUPS_CD", 
        "여행자수작업선별사유코드": "PSNR_HNWR_SELC_RCD", "여행자우범등급코드": "PSNR_LBCR_GD_CD", "요청정보대상구분코드": "REQT_INFO_TRGT_TPCD", 
        "용도구분코드": "USG_TPCD", "우범등급코드": "LBCR_GD_CD", "우범사이트추적근원구분코드": "LBCR_SITE_TRCN_SRC_TPCD", 
        "우범사이트품명코드": "LBCR_SITE_PRNM_CD", "우편물기타폐기사유코드": "PSMT_OTH_DSCD_RCD", "우편물면세사유코드": "PSMT_TXFR_RCD", 
        "우편물반송사유코드": "PSMT_RETU_RCD", "우편물종류코드": "PSMT_KCD", "우편물통관유의코드": "PSMT_CSCL_ATENT_CD", "우편물폐기사유코드": "PSMT_DSCD_RCD", 
        "운송사업종류코드": "TRNP_BUSI_KCD", "운송수단유형코드": "TRNP_METH_PCD", "운송수단임차신청사유코드": "TRNP_METH_HIRE_RQST_RCD", 
        "운송용기구분코드": "TRNP_CNTAI_TPCD", "운항계획정정사유코드": "SLNG_PLAN_MDFY_RCD", "원산지결정기준코드": "ORCY_DTRM_BASE_CD", 
        "원산지증명발급구분코드": "CNVN_TPCD_01", "원산지증명서유무구분코드": "ORCY_CRPP_EON_TPCD", "원산지표시면제사유코드": "ORCY_INDC_EXMP_RCD", 
        "원산지표시방법코드": "ORCY_INDC_MCD", "원산지표시유무구분코드": "ORCY_INDC_EON_TPCD", "원재료구분코드": "RWMS_TPCD", "위반유형코드": "VLTN_PCD", 
        "위해물품반출입사유코드": "INJR_CMDT_RLBR_RCD", "위해물품조치결과코드": "INJR_CMDT_TKAC_RSCD", "위해물품종류코드": "INJR_CMDT_KCD", 
        "은닉수법코드": "CNCM_TCHN_CD", "의무이행요구사유코드": "DTY_FFMN_REQS_RCD", "이사자직업코드": "IMGR_JOB_CD", "이체대사결과코드": "FNTR_CMVL_RSCD", 
        "인도조건코드": "DLCN_CD", "인증수출자반려취소사유코드": "CRTF_EXPPN_RTRN_CNCL_RCD", "인증수출자시정보정사유코드": "CRTF_EXPPN_CRCT_RVSN_RCD", 
        "일제점검선정사유코드": "ALTG_CHK_SLCN_RCD", "입출항구분코드": "IOPR_TPCD", "입출항서류정정항목코드": "IOPR_ISTM_MDFY_ITEM_CD", 
        "입출항정정사유코드": "IOPR_MDFY_RCD", "입출항화물코드": "IOPR_CARG_CD", "입항목적코드": "ETPR_PUPS_CD", "입항적하목록정정항목코드": "ETPR_MNFS_MDFY_ITEM_CD", 
        "자격전환정정사유코드": "QLFC_CHG_MDFY_RCD", "자격증종류코드": "CRQL_KCD", "자격취득구분코드": "QLFC_ACQS_TPCD", "자금원천구분코드": "CPTL_SRCE_TPCD", 
        "자동차업무코드": "CAR_BSOP_CD", "자동차차종코드": "CAR_KCAR_CD", "자료제공거부코드": "DTA_OFR_REJC_CD", "재수출이행의무종결사유코드": "REEXP_FFMN_DTY_CONC_RCD", 
        "적발근거코드": "DSCL_BSS_CD", "적발기법코드": "DSCL_TECN_CD", "적발단서코드": "DSCL_PRVS_CD", "적발유형코드": "DSCL_PCD", "적발장소코드": "DSCL_PLC_CD", 
        "적발항목코드": "DSCL_ITEM_CD", "적하목록미제출조치사항코드": "MNFS_NSBM_TKAC_MATR_CD", "적하목록상이내역코드": "MNFS_DFRN_BRKD_CD", 
        "적하목록정정사유코드": "MNFS_MDFY_RCD", "점검조치결과코드": "CHK_TKAC_RSCD", "정보분석대상품목코드": "INFO_ANAY_TRGT_PRLST_CD", 
        "정보분석등급코드": "INFO_ANAY_GD_CD", "정보입수구분코드": "INFO_OBTN_TPCD", "제재유형코드": "RSTN_PCD", "조사대상신고번호구분코드": "INVG_TRGT_DCLR_NO_TPCD", 
        "조사대상업무구분코드": "INVG_TRGT_BSOP_TPCD", "조사란구분코드": "INVG_LN_TPCD", "조사직원교육코드": "INVG_EMP_EDCT_CD", 
        "조사직원전문분야코드": "INVG_EMP_SPCL_RLM_CD", "조사해제사유코드": "INVG_RELE_RCD", "주소변동사유코드": "ADDR_VRBL_RCD", 
        "중량수량단위코드": "WGHT_QTY_UT_CD", "중요품목코드": "IMPO_PRLST_CD", "즉시반출대상품목구분코드": "IMDT_RLSE_TRGT_PRLST_TPCD", 
        "지인관계코드": "ACQU_RLCD", "직권정산대상업체사유코드": "OFAT_EXCA_TRGT_ENTS_RCD", "직급코드": "CLPS_CD", "직렬코드": "JBLN_CD", 
        "직무보조자구분코드": "DUTY_ASSN_TPCD", "직업분류코드": "JOB_CLSF_CD", "직업코드": "JOB_CD", "직원징계종류코드": "EMP_DSCP_KCD", 
        "직위코드": "OFPO_CD", "징수형태코드": "COLT_FORM_CD", "차량색상코드": "VHCL_CLR_CD", "차량용도코드": "VHCL_USG_CD", 
        "체납발생사유코드": "DLPY_OCRN_RCD", "체화공매불출구분코드": "OVGD_PBAC_GBOO_TPCD", "체화해제사유코드": "OVGD_RELE_RCD", 
        "추가추징납부사유코드": "ADIT_ADCH_PAY_RCD", "추가환급사유코드": "ADIT_DRWB_RCD", "추징고지상세사유코드": "ADCH_NFCPN_DTL_RCD", 
        "추징발생원인구분코드": "ADCH_OCRN_CSE_TPCD", "추징사유코드": "ADCH_RCD", "출항적하목록정정항목코드": "TKOF_MNFS_MDFY_ITEM_CD", 
        "컨테이너검색기위치코드": "CNTR_DTCT_LOCT_CD", "컨테이너길이코드": "CNTR_LEN_CD", "컨테이너너비높이코드": "CNTR_WIDT_HIGT_CD", 
        "컨테이너종류코드": "CNTR_KCD", "통계용선박용도종류코드": "FSTA_SHIP_USG_KCD", "통관고유부호사용정지사유코드": "ECM_USE_STOP_RCD", 
        "통관고유부호사용정지해제사유코드": "ECM_USE_STOP_RELE_RCD", "통관목록검사결과코드": "CSCL_LST_INSC_RSCD", "통관보류사유코드": "CSCL_PSTP_RCD", 
        "통관보류조치코드": "CSCL_PSTP_TKAC_CD", "통화코드": "CURR_CD", "투시결과코드": "CLRV_RSCD", "평가대상업체업종코드": "EV_TRGT_ENTS_INTP_CD", 
        "포상종류코드": "RWRD_KCD", "포장종류코드": "PCK_KCD", "피의자관계코드": "SSPN_RLCD", "하선물품구분코드": "ULVS_CMDT_TPCD", "학력코드": "ACAR_CD", 
        "한베트남FTA수량단위코드": "KVN_FTA_QTY_UT_CD", "한베트남FTA중량단위코드": "KVN_FTA_WGHT_UT_CD", "한베트남FTA포장종류코드": "KVN_FTA_PCK_KCD", 
        "한인니FTA수량단위코드": "KID_FTA_QTY_UT_CD", "한인니FTA중량단위코드": "KID_FTA_WGHT_UT_CD", "한인니FTA포장종류코드": "KID_FTA_PCK_KCD", 
        "항공기자격정정코드": "AIR_QLFC_MDFY_CD", "항공기종류코드": "AIR_KCD", "항공입항정정항목코드": "FLGH_ETPR_MDFY_ITEM_CD", "항해구분코드": "VYG_TPCD", 
        "해상입항정정항목코드": "SEA_ETPR_MDFY_ITEM_CD", "해상항공구분코드": "SEA_FLGH_TPCD", "행정제재유형코드": "ADPN_PCD", "허가수리구분코드": "PERM_ACPT_TPCD", 
        "현장면세배제코드": "SPOT_TXFR_EXCU_CD", "혐의자구분코드": "SSPT_TPCD", "협정구분코드": "CNVN_TPCD", "혼인관계코드": "MRGE_RLCD", 
        "화물검사조치결과코드": "CARG_INSC_TKAC_RSCD", "화물구분코드": "CARG_TPCD", "화물선별구분코드": "CARG_SELC_TPCD", "화물특성구분코드": "CARG_CHRC_TPCD", 
        "확인적발경위코드": "CFRM_DSCL_CRCM_CD", "환급근거서류구분코드": "DRWB_BSS_ISTM_TPCD", "환급대상정정취하사유코드": "DRWB_TRGT_MDFY_WTHD_RCD", 
        "환급대상확인신청서기각사유코드": "DRWB_TRGT_CFRM_APFM_DSMS_RCD", "환급사후심사착수구분코드": "DRWB_PSAD_OTST_TPCD", 
        "환급사후심사착수방안구분코드": "DRWB_PSAD_OTST_PLN_TPCD", "환급신청인구분코드": "DRWB_APLC_TPCD", "환급위험도항목구분코드": "DRWB_DNDG_ITEM_TPCD", 
        "환급제증명오류코드": "DRWB_OCMT_ERR_CD", "환급종류코드": "DRWB_KCD", "회사구분코드": "CO_TPCD", "휴대품가격평가방법코드": "HNBG_PRC_EV_MCD", 
        "휴대품검사결과코드": "HNBG_INSC_RSCD", "휴대품검사사유코드": "HNBG_INSC_RCD", "휴대품면세조항코드": "HNBG_TXFR_CLSE_CD", 
        "휴대품세율적용구분코드": "HNBG_TXRT_APLY_TPCD", "휴대품품명코드": "HNBG_PRNM_CD", "휴무구분코드": "CLSD_TPCD", "휴업폐업사유코드": "SSBS_QIBS_RCD" 
    }
    ...
    MAP_CORP = {
        "FIU금융기관코드": "FIU_FNIN_CD", "건설기계등록기관코드": "CNSC_MCHN_RGSR_ITT_CD", "검사검역기관코드": "INSC_QUAN_ITT_CD", 
        "검사검역소속기관코드": "INSC_QUAN_BLNG_ITT_CD", "공항부호목록": "ARPRT", "과코드": "DVSN_CD", "관계기관코드": "CNOR_CD", 
        "관세사목록": "CCA", "관세청관련기관코드": "KCS_RELA_ITT_CD", "국가기관구분코드": "CNTY_ITT_TPCD", "국가코드": "CNTY_CD", 
        "국코드": "BRAU_CD", "마약적발외부기관코드": "NRCT_DSCL_XTRN_ITT_CD", "물품용역공급업체부호목록": "SPPLYR", "보세구역": "BNDA", 
        "보세구역부호": "SNAR_SGN", "보세운송업자목록": "BNDT", "분석기관구분코드": "ANAY_ITT_TPCD", "산업단지코드": "INES_CD", 
        "선박회사": "SHIP", "세관구분코드": "CSTM_TPCD", "세관부호": "CSTM_SGN", "자동차등록기관코드": "CAR_RGSR_ITT_CD", 
        "적발기관코드": "DSCL_ITT_CD", "추징기관구분코드": "ADCH_ITT_TPCD", "통관우체국코드": "CSCL_PSOF_CD", "특송업체부호": "EXML_ENTS_CD", 
    ...
    def render_statics_quadrant(title, url, mapping_dict, key_prefix):
        ...
        btn_clicked = st.button(f"🔍 {title} 조회", key=f"{key_prefix}_btn", use_container_width=True)
        
        if btn_clicked or selected_name != "":
            if selected_name:
                target_sheet = mapping_dict.get(selected_name)
                with st.spinner(f"데이터를 가져오는 중..."):
                    try:
                        conn = st.connection("gsheets", type=GSheetsConnection)
                        df = conn.read(spreadsheet=url, worksheet=target_sheet, ttl=3600)
                        if df is not None and not df.empty:
                            st.success(f"'{selected_name}' 조회 완료")
                            st.dataframe(df, use_container_width=True, hide_index=True, height=300)
                            csv_data = df.to_csv(index=False).encode('utf-8-sig')
                            st.download_button(label="📥 CSV 다운로드", data=csv_data, file_name=f"{selected_name}.csv", mime="text/csv", key=f"{key_prefix}_dl")
                        else:
                            st.warning("데이터가 비어있습니다.")
                    except:
                        st.error(f"시트 '{target_sheet}'를 찾을 수 없습니다.")
            else:
                st.caption("항목을 선택하세요.")

    # --- 3. 2x2 레이아웃 배치 ---
    t_left, t_right = st.columns(2)
    with t_left:
        with st.container(border=True):
            render_statics_quadrant("💰 1. 세율부호", URL_TAX, MAP_TAX, "q1")
    with t_right:
        with st.container(border=True):
            render_statics_quadrant("📌 2. 고정부호", URL_FIX, MAP_FIX, "q2")

    b_left, b_right = st.columns(2)
    with b_left:
        with st.container(border=True):
            render_statics_quadrant("🛡️ 3. 수출입요건", URL_REQ, MAP_REQ, "q3")
    with b_right:
        with st.container(border=True):
            render_statics_quadrant("🌆 4. 업체/기관/지역부호", URL_CORP, MAP_CORP, "q4")
